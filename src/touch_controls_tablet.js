...
function initializeTouchControls() {
    controlsRoot.dataset.cameraReady = String(Boolean(window.touchGameCamera));
    ...
    function updateJoystick(event) {
        ...
        controlsRoot.dataset.moveActive = 'true';
    ...
    lookZone?.addEventListener('pointermove', event => {
        ...
        if (!camera) {
            controlsRoot.dataset.cameraReady = 'false';
            return;
        }
        controlsRoot.dataset.cameraReady = 'true';
        controlsRoot.dataset.lookMoved = 'true';
    ...
    const bindAction = (id, mouseButton) => {
        ...
        button.addEventListener('pointerdown', event => {
            ...
            controlsRoot.dataset.lastAction = id;
    ...
    jumpButton?.addEventListener('pointerdown', event => {
        ...
        controlsRoot.dataset.lastAction = 'mobile-jump-btn';
    ...
    pauseButton?.addEventListener('pointerdown', event => {
        ...
        event.stopPropagation();
        resetMovement();
        controlsRoot.dataset.lastAction = 'mobile-pause-btn';
